...
### Added
- **Modern badge styling for status indicators** - Enhanced visual appearance of status badges in the UI with improved styling and consistency

## [3.20.1] - 2026-01-27

### Fixed
- **Improved keyboard shortcut hints styling and display logic** - Enhanced visual presentation and conditional display of keyboard shortcuts in pane borders
